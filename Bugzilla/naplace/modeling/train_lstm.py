...
if __name__ == "__main__":
    ...
    with mlflow.start_run(run_name="lstm_train"):
        mlflow.log_params(
            {
                "model": "lstm",
                "max_words": max_words,
        ...
        metrics_path = Path("reports/metrics_lstm.json")
        ...
        print("LSTM training completato e loggato su MLflow.")
